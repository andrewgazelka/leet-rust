...
impl Solution {
    pub fn is_possible(nums: Vec<i32>) -> bool {
        ...
        let mut seq_lens = VecDeque::from(vec![1]);
            ...
            match dif {
                ...
                1 => {
                    ...
                    for _ in 0..sequence_on {
                        let len = seq_lens.pop_front().unwrap();
                        if len < 3 {
                            return false;
                        }
                    }
                ...
                _ => {
                    while let Some(elem) = seq_lens.pop_front() {
                        if elem < 3 {
                            return false;
                        }
                    }
        ...
        seq_lens.into_iter().all(|len| len >= 3)
    }
}
